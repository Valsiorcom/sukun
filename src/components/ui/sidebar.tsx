        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              <SheetTitle>Panel Samping</SheetTitle>
              <SheetDescription>Menampilkan panel samping versi mobile.</SheetDescription>
            </SheetHeader>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <PanelLeft />
      <span className="sr-only">Buka/Tutup Panel Samping</span>
    </Button>
  );
});
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        data-sidebar="rail"
        aria-label="Buka/Tutup Panel Samping"
        tabIndex={-1}
        onClick={toggleSidebar}
        title="Buka/Tutup Panel Samping"
        className={cn(
